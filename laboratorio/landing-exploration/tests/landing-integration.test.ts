...
import { renderLanding } from "../generadores/templates/landing/index.js";
...
describe("renderLanding â€” integration", () => {
  ...
  it("renders every case from /perfil/data/cases/*.md by title", () => {
