...
| Skills / portfolio / CV | `C:\dev\dr-cv` | Generadores, perfil/data YAML, respuestas UR completas |
...
|---|---|---|
| Evaluacion de skills | `C:\dev\dr-cv` | `node career-training/ur-assessment/server.js` |
