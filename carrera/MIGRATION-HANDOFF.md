...
- **Migracion de carpeta completada el 2026-06-11**: la carpeta vive en `C:\dev\dr-cv\carrera` (renombrada, sin espacios).
...
- `career-training/ur-assessment/answers.md`
- `carrera/daily/index.html`
