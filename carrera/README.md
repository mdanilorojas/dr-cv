...
Centro de comando para conectar estrategia profesional, career training, portfolio, Life Update y validacion comercial.
...
1. Career training: respuestas con calidad senior.
...
| Dominio | Fuente |
|---|---|
| Career training / CV / portfolio | `C:\dev\dr-cv` |
| Preguntas career training | `C:\dev\dr-cv\career-training\ur-assessment\questions.md` |
...
`C:\dev\dr-cv\career-training\ur-assessment\index.html` es la fuente unica de `danilorojas.design/app`. El build de la landing lo copia a `dist/landing-v11/app/`.
...
Completada el 2026-06-11: este directorio vive en `C:\dev\dr-cv\carrera`. Historial en [`MIGRATION-HANDOFF.md`](MIGRATION-HANDOFF.md).
