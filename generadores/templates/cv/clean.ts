...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) in Figma (Variables, Auto Layout, Dev Mode) — compliant with WCAG 2.2 and Section 508, passing 95%+ of automated accessibility checks. Cut design-to-development cycle from ~6 weeks to under 1 week by delivering production-ready React components. Pioneered agentic UX research: built LLM-based persona emulators running hundreds of automated usability tests per screen, validated with moderated usability testing (5 users per feature) — 92% rated the resulting improvements as better. Design system scaled from 0 to 26 internal teams, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) en Figma (Variables, Auto Layout, Dev Mode) — conformes con WCAG 2.2 y Sección 508, superando el 95%+ de checks automatizados de accesibilidad. Reduje el ciclo design-to-development de ~6 semanas a menos de 1 semana entregando componentes React listos para producción. Pionero en investigación UX agéntica: construí emuladores de personas basados en LLM que corrían cientos de pruebas automatizadas por pantalla, validadas con usability testing moderado (5 usuarios por feature) — 92% calificó las mejoras como superiores. El design system escaló de 0 a 26 equipos internos, incluyendo el producto de ciberseguridad Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch and shipping a validated MVP in 40 days. Rebuilt a failing onboarding funnel in under 3 weeks using AI-persona feedback loops; instrumented end-to-end analytics in Mixpanel — new-user activation rose from 2.6% to 9.4%. Ran an A/B test (email vs. Google sign-in), lifting onboarding completion 74%. Designed a 31-component Figma design system (Variables, Auto Layout) across 16 screens, implemented directly in React/TypeScript.",
      es: "Líder de diseño de producto para un SaaS de compliance para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Reconstruí un funnel de onboarding roto en menos de 3 semanas usando loops de feedback con personas IA; instrumenté analytics end-to-end en Mixpanel — la activación de nuevos usuarios subió de 2.6% a 9.4%. Corrí un A/B test (email vs. Google), subiendo la finalización del onboarding en 74%. Diseñé un design system de 31 componentes en Figma (Variables, Auto Layout) en 16 pantallas, implementado directamente en React/TypeScript."
    } },
