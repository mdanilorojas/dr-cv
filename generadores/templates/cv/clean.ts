...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — passing 95%+ of automated accessibility checks. Delivered production-ready React components, cutting design-to-dev cycle from ~6 weeks to under 1 week. Pioneered agentic UX research: built LLM-based persona emulators to run moderated usability testing (5 users per feature), with 92% rating improvements better. Designed a custom MCP for developers; design system scaled from 0 to 26 teams at Booz Allen Hamilton.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados. Entregué componentes React listos para producción, reduciendo el ciclo design-to-dev de ~6 semanas a menos de 1 semana. Pionero en investigación UX agéntica: construí emuladores de personas LLM para pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos en Booz Allen Hamilton."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, shipping a validated MVP in 40 days. Rebuilt the onboarding funnel in under 3 weeks using AI-persona feedback loops and Mixpanel analytics — raising new-user activation from 2.6% to 9.4%; A/B test on sign-up method lifted onboarding completion by 74%. Designed a 31-component Figma design system implemented directly in React/TypeScript, growing the product to ~280 paying customers.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, validando el MVP en 40 días. Reconstruí el funnel de onboarding en menos de 3 semanas con personas IA y Mixpanel — subiendo la activación de 2.6% a 9.4%; un A/B test elevó la finalización del onboarding en 74%. Diseñé un design system de 31 componentes en Figma implementado en React/TypeScript, creciendo el producto a ~280 clientes de pago."
    } },
