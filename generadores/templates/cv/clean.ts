...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — 95%+ automated accessibility checks passed. Pioneered agentic UX research: built LLM-based persona emulators for moderated usability testing (5 users per feature), with 92% rating the resulting improvements better; cut design-to-dev cycle from ~6 weeks to under 1 week via Figma Variables, Dev Mode and component-first delivery. Design system scaled from 0 to 26 internal teams at Booz Allen Hamilton, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados de accesibilidad. Fui pionero en investigación UX agéntica: construí emuladores de personas LLM para pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación; reduje el ciclo design-to-dev de ~6 semanas a menos de 1 semana via Figma Variables, Dev Mode y entrega component-first. El design system escaló de 0 a 26 equipos internos en Booz Allen Hamilton, incluyendo el producto de ciberseguridad Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented product analytics in Mixpanel and redesigned the onboarding flow, raising new-user activation from 2.6% to 9.4% in under 3 weeks. A/B tested sign-up methods (email vs. Google Sign-In); winning variant improved onboarding completion 74%. Designed a 31-component Figma design system implemented directly in React/TypeScript; ran AI-persona feedback loops to validate flows pre-engineering.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Instrumenté analytics de producto en Mixpanel y rediseñé el onboarding, subiendo la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. A/B test de métodos de registro (email vs. Google Sign-In); la variante ganadora mejoró la completion del onboarding en 74%. Diseñé un design system de 31 componentes en Figma implementado en React/TypeScript; corrí loops de feedback con personas IA para validar flujos antes de ingeniería."
    } },
...
const CAPS: Cap[] = [
  { label: { en: "Product & UX", es: "Producto y UX" }, detail: { en: "User Research · Usability Testing · Journey Mapping · A/B Testing · Mixpanel · NPS/CSAT", es: "Investigación UX · Pruebas de Usabilidad · Journey Mapping · A/B Testing · Mixpanel · NPS/CSAT" } },
