...
const ROWS: Row[] = [
  ...
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Designed a 31-component Figma design system used across 16 screens and implemented in React/TypeScript. Instrumented analytics in Mixpanel and rebuilt the onboarding funnel — new-user activation from 2.6% to 9.4% in under 3 weeks; A/B tested sign-up methods, lifting onboarding completion 74%. Product grew to ~280 paying customers on ~2,700 total users.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Diseñé un design system de 31 componentes en Figma usado en 16 pantallas, implementado en React/TypeScript. Instrumenté analytics en Mixpanel y reconstruí el funnel de onboarding — activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas; A/B test de registro, subiendo la completación del onboarding en 74%. El producto creció a ~280 clientes pagando sobre ~2,700 usuarios."
    } },
