...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Led design for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — passing 95%+ automated accessibility checks. Reduced design-to-dev cycle from ~6 weeks to under 1 week through agent-ready workflows; design system adopted organically by 26 internal teams (including Vellox Reverser). Pioneered agentic UX research: built LLM-based persona emulators to run moderated usability tests (5 users per feature); 92% rated resulting improvements better. Designed a custom MCP for developers; implemented NPS and CSAT for product measurement.",
      es: "Lideré el diseño de la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados de accesibilidad. Reduje el ciclo de diseño a desarrollo de ~6 semanas a menos de 1 semana mediante workflows agénticos; el design system fue adoptado orgánicamente por 26 equipos internos (incluyendo Vellox Reverser). Fui pionero en investigación de UX agéntica: construí emuladores de personas basados en LLM para correr pruebas de usabilidad moderadas (5 usuarios por feature); 92% aprobó las mejoras resultantes. Diseñé un MCP propio para developers; implementé NPS y CSAT para medición de producto."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Owned end-to-end discovery-to-launch design for a compliance SaaS for LATAM SMBs, shipping a validated MVP in 40 days. Instrumented product analytics in Mixpanel; ran A/B testing (Google login vs email) and AI-persona feedback loops, increasing new-user activation from 2.6% to 9.4% in under 3 weeks and improving onboarding completion by 74%. Designed a 31-component Figma design system implemented directly in React/TypeScript, scaling the product to ~280 paying customers.",
      es: "Diseñé de extremo a extremo el producto para un SaaS de cumplimiento para PYMES LATAM, validando el MVP en 40 días. Instrumenté analytics de producto en Mixpanel; corrí A/B testing (Google login vs email) y loops de feedback con personas IA, aumentando la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas y mejorando la completion del onboarding en 74%. Diseñé un design system de 31 componentes en Figma implementado directamente en React/TypeScript, escalando el producto a ~280 clientes pagando."
    } },
