...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting 2 design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — passing 95%+ of automated accessibility checks — and cutting design-to-dev cycle from ~6 weeks to under 1 week via production-ready React components. Pioneered agentic UX research: built LLM-based persona emulators running automated usability tests per screen, validated with moderated testing (5 users per feature) — 92% rated the improvements better. Designed a custom MCP for developers; design system scaled from 0 to 26 internal teams at Booz Allen Hamilton, including Vellox Reverser (cybersecurity).",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo 2 design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados — y reduciendo el ciclo design-to-dev de ~6 semanas a menos de 1 semana mediante componentes React listos para producción. Pionero en investigación UX agéntica: construí emuladores de persona basados en LLM corriendo pruebas automatizadas por pantalla, validadas con testing moderado (5 usuarios por feature) — 92% calificó las mejoras como superiores. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos internos en Booz Allen Hamilton, incluyendo Vellox Reverser (ciberseguridad)."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs — shipped a validated MVP in 40 days. Instrumented Mixpanel end-to-end, defined the activation metric, and rebuilt the onboarding funnel using usability testing and AI-persona loops — raising new-user activation from 2.6% to 9.4% in under 3 weeks. A/B-tested email vs. Google sign-in; Google won, lifting onboarding completion 74%. Designed a 31-component Figma (Variables, Auto Layout) design system across 16 screens, implemented directly in React 19 / TypeScript.",
      es: "Líder de diseño de producto para un SaaS de compliance para PYMES LATAM — MVP validado en 40 días. Instrumenté Mixpanel end-to-end, definí la métrica de activación y reconstruí el funnel de onboarding con usability testing y loops de personas IA — subiendo la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. A/B test de email vs. Google sign-in; ganó Google, elevando la finalización del onboarding un 74%. Diseñé un design system de 31 componentes Figma (Variables, Auto Layout) en 16 pantallas, implementado directamente en React 19 / TypeScript."
    } },
