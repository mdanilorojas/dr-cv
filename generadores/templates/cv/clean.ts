...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) in Figma (Variables, Auto Layout, Dev Mode) — compliant with WCAG 2.2 and Section 508, passing 95%+ of automated accessibility checks. Cut design-to-dev cycle from ~6 weeks to under 1 week by delivering near-production-ready React code. Pioneered agentic UX research: built LLM-based persona emulators to run moderated usability testing (5 users per feature), with 92% rating improvements better. Designed a custom MCP for developers; design system scaled from 0 to 26 internal teams at Booz Allen Hamilton, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) en Figma (Variables, Auto Layout, Dev Mode) — conformes con WCAG 2.2 y Sección 508, superando el 95% de checks automatizados. Reduje el ciclo design-to-dev de ~6 semanas a menos de 1 semana entregando código React casi listo para producción. Fui pionero en investigación UX agéntica: construí emuladores de personas basados en LLM para pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos en Booz Allen Hamilton, incluyendo Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented product analytics in Mixpanel; redesigned onboarding and raised new-user activation from 2.6% to 9.4% in under 3 weeks. A/B-tested email vs. Google sign-in — Google won, lifting onboarding completion 74%. Designed a 31-component Figma design system, used across 16 screens and implemented directly in React/TypeScript. Ran AI-persona feedback loops to validate flows pre-engineering, growing the product to ~280 paying customers.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, validando el MVP en 40 días. Instrumenté analytics en Mixpanel; rediseñé el onboarding y elevé la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. A/B test email vs. Google — ganó Google, mejorando la completion del onboarding en 74%. Diseñé un design system de 31 componentes en Figma, implementado en React/TypeScript. Corrí loops de feedback con personas IA para validar flujos antes de ingeniería, creciendo el producto a ~280 clientes pagando."
    } },
