...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) using Figma (Variables, Auto Layout, Dev Mode) — WCAG 2.2 and Section 508 compliant, passing 95%+ of automated accessibility checks. Pioneered agentic UX research: built LLM persona emulators for moderated usability testing (5 users per feature), with 92% rating improvements better; cut design-to-dev cycle from ~6 weeks to under 1 week. Designed a custom MCP for developers; design system scaled to 26 internal teams at Booz Allen Hamilton.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) con Figma (Variables, Auto Layout, Dev Mode) — conformes con WCAG 2.2 y Sección 508, superando el 95% de checks automatizados de accesibilidad. Fui pionero en investigación de UX agéntica: construí emuladores de personas LLM para pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación; reduje el ciclo design-to-dev de ~6 semanas a menos de 1 semana. Diseñé un MCP propio para developers; el design system escaló a 26 equipos internos en Booz Allen Hamilton."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented end-to-end product analytics in Mixpanel; redesigned onboarding — raised new-user activation from 2.6% to 9.4% in under 3 weeks. Ran A/B test (email vs. Google sign-in), improving onboarding completion 74%. Designed a 31-component Figma design system implemented directly in React/TypeScript, scaling to ~280 paying customers.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Instrumenté analytics end-to-end en Mixpanel; rediseñé el onboarding — subí la activación de nuevos usuarios de 2,6% a 9,4% en menos de 3 semanas. Corrí A/B test (registro email vs. Google), mejorando la completion del onboarding 74%. Diseñé un design system de 31 componentes en Figma implementado en React/TypeScript, creciendo a ~280 clientes pagando."
    } },
