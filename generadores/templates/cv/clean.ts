...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Led end-to-end product design for the federal Trusted Environments platform and Developer Portal — cutting design-to-dev cycle from ~6 weeks to under 1 week. Architected two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508, passing 95%+ of automated accessibility checks; scaled from 0 to 26 internal teams at Booz Allen Hamilton, including the Vellox Reverser cybersecurity product. Pioneered agentic UX research: built LLM-based persona emulators running moderated usability tests (5 users per feature); 92% rated the improvements better. Designed a custom MCP for developers.",
      es: "Lideré el diseño de producto end-to-end de la plataforma federal Trusted Environments y el Developer Portal — reduciendo el ciclo design-to-dev de ~6 semanas a menos de 1 semana. Arquitecté dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508, superando el 95%+ de checks automatizados; escalé de 0 a 26 equipos internos en Booz Allen Hamilton, incluyendo Vellox Reverser. Pionero en investigación UX agéntica: emuladores de persona LLM para usability testing moderado (5 usuarios por feature); 92% calificó las mejoras como superiores. Diseñé un MCP propio para developers."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Owned discovery-to-launch design for a compliance SaaS for LATAM SMBs, shipping a validated MVP in 40 days. Instrumented end-to-end analytics in Mixpanel; rebuilt onboarding funnel — lifting new-user activation from 2.6% to 9.4% in under 3 weeks. A/B tested onboarding sign-up (email vs. Google sign-in); Google won, improving completion by 74%. Designed a 31-component Figma design system implemented in React/TypeScript; validated via AI-persona loops, growing to ~280 paying customers.",
      es: "Dueño del diseño de discovery a lanzamiento de un SaaS de cumplimiento para PYMES LATAM, validando el MVP en 40 días. Instrumenté analytics end-to-end en Mixpanel; reconstruí el funnel de onboarding — elevando activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. A/B test sobre el registro (email vs. Google); Google ganó, mejorando completion del onboarding en 74%. Diseñé un design system de 31 componentes en Figma implementado en React/TypeScript; validé con personas IA, creciendo a ~280 clientes pagando."
    } },
