...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — passing 95%+ of automated accessibility checks — cutting design-to-development cycle from ~6 weeks to under 1 week. Pioneered agentic UX research: built LLM-based persona emulators to run moderated usability testing (5 users per feature), with 92% rating the resulting improvements better. Designed a custom MCP for developers; design system scaled from 0 to 26 internal teams at Booz Allen Hamilton, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados de accesibilidad — y reduciendo el ciclo design-to-development de ~6 semanas a menos de 1 semana. Fui pionero en investigación de UX agéntica: construí emuladores de personas basados en LLM para correr pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación sobre las mejoras resultantes. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos internos en Booz Allen Hamilton, incluyendo el producto de ciberseguridad Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented Mixpanel end-to-end; rebuilt a failing onboarding funnel using AI-persona loops and usability testing — new-user activation rose from 2.6% to 9.4% in under 3 weeks. Validated a social-login A/B test (email vs. Google sign-in) that lifted onboarding completion by 74%. Shipped a 31-component Figma design system in React/TypeScript; the product serves ~280 paying customers on a base of ~2,700 total users.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Instrumenté Mixpanel end-to-end; reconstruí un funnel de onboarding roto con loops de personas IA y usability testing — la activación de nuevos usuarios subió de 2.6% a 9.4% en menos de 3 semanas. Diseñé y corrí un A/B test (email vs. acceso con Google) que elevó la finalización del onboarding en 74%. Entregué un design system de 31 componentes en React/TypeScript; el producto atiende ~280 clientes de pago sobre una base de ~2,700 usuarios."
    } },
