...
const ROWS: Row[] = [
  ...
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented analytics in Mixpanel; redesigned onboarding lifted new-user activation from 2.6% to 9.4% in under 3 weeks. A/B-tested sign-up (email vs. Google SSO) — Google SSO won, lifting onboarding completion 74%. Designed a 31-component Figma design system implemented in React/TypeScript; product serves ~280 paying customers on ~2,700 total users.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, validando el MVP en 40 días. Instrumenté analytics en Mixpanel; el rediseño del onboarding subió la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. A/B test sobre el registro (email vs. Google SSO) — ganó Google SSO, subiendo la finalización del onboarding en 74%. Design system de 31 componentes en Figma implementado en React/TypeScript; ~280 clientes de pago sobre ~2,700 usuarios totales."
    } },
