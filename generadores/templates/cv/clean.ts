...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal (Army, DoD, VA, FAA), architecting two design systems (Shadcn, Radix, BAH Brand Book; Figma Variables, Auto Layout, Dev Mode) compliant with WCAG 2.2 and Section 508 — passing 95%+ of automated accessibility checks. Reduced design-to-development cycle from ~6 weeks to under 1 week by delivering production-ready React components. Pioneered agentic UX research: built LLM-based persona emulators running automated usability tests (5 moderated sessions per feature); 92% of users rated the resulting improvements better. Designed a custom MCP for developers; design system scaled from 0 to 26 internal teams at Booz Allen Hamilton, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y Developer Portal (Army, DoD, VA, FAA), construyendo dos design systems (Shadcn, Radix, BAH Brand Book; Figma Variables, Auto Layout, Dev Mode) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados de accesibilidad. Reduje el ciclo design-to-development de ~6 semanas a menos de 1 semana entregando componentes React listos para producción. Fui pionero en investigación de UX agéntica: construí emuladores de personas basados en LLM que corrían pruebas de usabilidad automáticas (5 sesiones moderadas por feature); el 92% de usuarios calificó las mejoras resultantes como mejores. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos internos en Booz Allen Hamilton, incluyendo el producto de ciberseguridad Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Instrumented end-to-end analytics in Mixpanel and defined the activation metric; redesigned the onboarding flow — increased new-user activation from 2.6% to 9.4% in under 3 weeks. Ran an A/B test (email vs. Google sign-in) that improved onboarding completion by 74%. Designed a 31-component Figma design system (Variables, Auto Layout, Dev Mode), used across 16 screens and implemented directly in React 19 / TypeScript — growing the product to ~280 paying customers on a base of ~2,700 total users.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Instrumenté analytics end-to-end en Mixpanel y definí la métrica de activación; rediseñé el flujo de onboarding — aumenté la activación de nuevos usuarios del 2,6% al 9,4% en menos de 3 semanas. Corrí un A/B test (email vs. acceso con Google) que mejoró la completion del onboarding en 74%. Diseñé un design system de 31 componentes en Figma (Variables, Auto Layout, Dev Mode), usado en 16 pantallas e implementado directamente en React 19 / TypeScript — creciendo el producto a ~280 clientes pagando sobre una base de ~2,700 usuarios totales."
    } },
...
const CAPS: Cap[] = [
  { label: { en: "Product & UX", es: "Producto y UX" }, detail: { en: "User Research · Usability Testing · A/B Testing · Mixpanel · Journey Mapping · NPS/CSAT", es: "Investigación UX · Pruebas de Usabilidad · A/B Testing · Mixpanel · Journey Mapping · NPS/CSAT" } },
  { label: { en: "Design Systems", es: "Design Systems" }, detail: { en: "Figma (Variables, Auto Layout, Dev Mode) · Shadcn · Radix · Storybook · WCAG 2.2 / Section 508", es: "Figma (Variables, Auto Layout, Dev Mode) · Shadcn · Radix · Storybook · WCAG 2.2 / Sección 508" } },
