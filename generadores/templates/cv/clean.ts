...
const ROWS: Row[] = [
  { years: "2022—NOW", co: "Booz Allen Hamilton", badge: "Army · DoD · VA · FAA",
    ...
    desc: {
      en: "Lead product designer for the federal Trusted Environments platform and Developer Portal, architecting two design systems (Shadcn, Radix, BAH Brand Book) compliant with WCAG 2.2 and Section 508 — passing 95%+ of automated accessibility checks. Pioneered agentic UX research: built LLM-based persona emulators to run moderated usability tests (5 users per feature), with 92% rating resulting improvements better; implemented NPS and CSAT to measure release impact. Delivered near-production-ready React components and interaction specs, reducing the design-to-dev cycle from ~6 weeks to under 1 week. Designed a custom MCP for developers; the design system scaled from 0 to 26 internal teams, including the Vellox Reverser cybersecurity product.",
      es: "Diseñador de producto principal para la plataforma federal Trusted Environments y el Developer Portal, construyendo dos design systems (Shadcn, Radix, BAH Brand Book) conformes con WCAG 2.2 y Sección 508 — superando el 95% de checks automatizados de accesibilidad. Fui pionero en investigación UX agéntica: construí emuladores de personas basados en LLM para correr pruebas de usabilidad moderadas (5 usuarios por feature), con 92% de aprobación; implementé NPS y CSAT para medir el impacto de releases. Entregué componentes React casi listos para producción y specs de interacción, reduciendo el ciclo design-to-dev de ~6 semanas a menos de 1 semana. Diseñé un MCP propio para developers; el design system escaló de 0 a 26 equipos internos, incluyendo el producto de ciberseguridad Vellox Reverser."
    } },
  { years: "2026—NOW", co: "Compliance SaaS · LATAM", badge: "280+ paying users",
    ...
    desc: {
      en: "Lead product designer for a compliance SaaS for LATAM SMBs, owning discovery-to-launch design and shipping a validated MVP in 40 days. Designed a 31-component Figma (Variables, Auto Layout) design system used across 16 screens, implemented directly in React 19/TypeScript. Instrumented product analytics in Mixpanel, defining the activation metric; onboarding redesign raised new-user activation from 2.6% to 9.4% in under 3 weeks. A/B tested registration (Google sign-in vs. email); Google sign-in won, improving onboarding completion 74%. Ran AI-persona feedback loops to validate flows pre-engineering, growing the product to ~280 paying customers on a base of ~2,700 total users.",
      es: "Líder de diseño de producto para un SaaS de cumplimiento para PYMES LATAM, dueño del diseño de discovery a lanzamiento y validando el MVP en 40 días. Diseñé un design system de 31 componentes en Figma (Variables, Auto Layout) usado en 16 pantallas e implementado directamente en React 19/TypeScript. Instrumenté analytics de producto en Mixpanel, definiendo la métrica de activación; el rediseño de onboarding subió la activación de nuevos usuarios de 2.6% a 9.4% en menos de 3 semanas. Realicé A/B test de registro (Google vs email); Google ganó, mejorando la completion del onboarding en 74%. Corrí loops de feedback con personas IA para validar flujos antes de ingeniería, creciendo el producto a ~280 clientes pagando sobre una base de ~2,700 usuarios totales."
    } },
