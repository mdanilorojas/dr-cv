...
async function main() {
  ...
  // Versión ATS fechada 2026-09-13: cotejo fact-bank × ATS Research Ciclo 39 — enviable.
  await emit("cv-ats-2026-09-13-en", renderAtsCv(data, "en"));
  await emit("cv-ats-2026-09-13-es", renderAtsCv(data, "es"));
