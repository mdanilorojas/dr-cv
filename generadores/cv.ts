...
async function main() {
  ...
  // Versión ATS fechada 2026-08-01: cotejo fact-bank × ATS Research Ciclo 39 — enviable.
  await emit("cv-ats-2026-08-01-en", renderAtsCv(data, "en"));
  await emit("cv-ats-2026-08-01-es", renderAtsCv(data, "es"));
