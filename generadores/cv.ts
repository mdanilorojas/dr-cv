...
async function main() {
  ...
  // Versión ATS fechada 2026-07-25: cotejo fact-bank × ATS Research ciclo 39 — enviable.
  await emit("cv-ats-2026-07-25-en", renderAtsCv(data, "en"));
  await emit("cv-ats-2026-07-25-es", renderAtsCv(data, "es"));
