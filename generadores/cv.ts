...
async function main() {
  ...
  // Versión ATS fechada 2026-08-04: cotejo fact-bank × ATS Research Ciclo 39 — enviable.
  await emit("cv-ats-2026-08-04-en", renderAtsCv(data, "en"));
  await emit("cv-ats-2026-08-04-es", renderAtsCv(data, "es"));
