...
async function main() {
  ...
  // Versión ATS fechada 2026-08-31: cotejo fact-bank × ATS Research Ciclo 39 — enviable.
  await emit("cv-ats-2026-08-31-en", renderAtsCv(data, "en"));
  await emit("cv-ats-2026-08-31-es", renderAtsCv(data, "es"));
